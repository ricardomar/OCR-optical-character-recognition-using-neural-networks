...
net = newff( ones(256,1) * [0 1], 10,{'purelin'},'traingd','learnhd');
...
save Wrede_cl_MA_purelin_hrdw_P500.dat Wrede /ascii;
save Brede_cl_MA_purelin_hrdw_P500.dat Brede /ascii;