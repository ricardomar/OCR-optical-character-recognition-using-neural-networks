% Conmputação Adaptativa, DEI, 2007
...
% Neste trabalho prático (CA-OCR, 2007) esta função é usada simplesmente
...
%
%Pode chamar-se de um script, com um número variável de argumentos (varargin, variable arguments input) ou correr-se  
...
% o resultado de "digitalização" da quadrícula é armazenado na estrutura
% data.X. Cara coluna de 256 linhas corresponde a um quadrado.
%
% Este ficheiro foi adaptado por J. Henriques para a cadeira de Computação
% Adaptativa em 2006.
%
% 1º Corre-se mpaper (sem fazer classificação, comentando a linha feval
% 2º Usa-se a matriz das entradas P assim criada para o nosso problema
% 3º Para se graficar cada entrada numa grelha, usar a função grafica
% (X,Y), que permite visualizar uma ou duas entradas.
% DEI Outubro de 2007.
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: 
...
function Dn(varargin)
 ...
 % segue-se a classificação se faz activando a linha seguinte 
 
             feval(options.fun,data);
             
 % feval vai calcular a função options.fun, que por defeito é a ocr_fun por defeito ;
